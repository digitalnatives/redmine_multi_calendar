...
module CalendarHelper
  ...
  def calendart_settings_tabs
    tabs = [ {:name => 'edit_calendar',
              :controller => 'calendar',
              :action => "edit",
              :partial => 'edit',
              :label => :edit_calendar },
             {:name => 'calendar_view',
              :controller => 'calendar_vacation',
              :action => "show",
              :partial => 'calendar_vacation/show',
              :label => :calendar_view },
             {:name => 'members',
              :controller => 'assign_calendar',
              :action => "new",
              :partial => 'assign_calendar/new',
              :label => :members },
             {:name => 'day_type',
              :controller => 'pattern_weeklies',
              :action => "index",
              :partial => 'pattern_weeklies/index',
              :label => :day_type }
            ]
  end
